namespace Glide
{
    ...
    public static class Ease
    {
        ...
        {
            return t == 1 ? 1 : (float)(Math.Sin(-13 * PI2 * (t + 1)) * Math.Pow(2, -10 * t) + 1);
        }
        ...
        {
            return t == 1 ? 1 : (float)(-Math.Cos(PI2 * t) + 1);
        }
        ...
        public static float BounceInOut(float t)
        {
            ...
            return t < B2
                ...
                : t < B4 ? (float)((7.5625 * (t - B5) * (t - B5) + .9375) / 2 + .5) : (float)((7.5625 * (t - B6) * (t - B6) + .984375) / 2 + .5);
        }
        ...
        {
            return t == 1 ? 1 : (float)(t < .5 ? Math.Pow(2, 10 * (t * 2 - 1)) / 2 : (-Math.Pow(2, -10 * (t * 2 - 1)) + 2) / 2);
        }
